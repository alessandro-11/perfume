...
import './App.css'
import Carmy from './assets/afnan.webp'
import Cjoa from './assets/ameer1.webp'
import Curs from './assets/vipblack.jpg'
import Slider1 from './assets/perfume1.png'
import Slider2 from './assets/perfume2.png'
        ...
        <section className="produtos">
          ...
          <a href="#" className="link-card">
            <div className="card">
              ...
              <h2 className="titulo-card">Al Noble Ameer</h2>
              <p className="desc">Perfume oriental e amadeirado, com oud e âmbar, criando uma fragrância luxuosa e misteriosa.</p>
          ...
          <a href="#" className="link-card">
            <div className="card">
              ...
              <h2 className="titulo-card">9PM Afnan</h2>
              <p className="desc">Doce e envolvente, com frutas, âmbar e musk, perfeito para momentos especiais e intensos.</p>
          ...
          <a href="#" className="link-card">
            <div className="card">
              ...
              <h2 className="titulo-card">212 VIP black</h2>
              <p className="desc">Fragrância urbana e sensual, com notas de anis, lavanda, couro e baunilha, ideal para a noite.</p>
              <p className="preco">R$ 299,99</p>
